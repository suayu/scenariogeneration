...
SOURCE_FILES = [
    ...
    'tests/riskweaver_joint_instructions.txt',
]
...
def freeze(path):
    ...
    manifest = {'scenario_files': [str(file) for file in files],
                ...
                'instruction_file': str(ROOT / 'tests/riskweaver_joint_instructions.txt')}
...
def main():
    ...
    overrides = ['sim.seed=42', f'sim.evaluation.max_scenarios={count}', 'sim.steps=400',
